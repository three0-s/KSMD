...
classes = ('rain', 'cloud', 'person', 'puddle', 'lightning', 'direct protection', 'indirect protection')
data = dict(
    train=dict(
        img_prefix='/home/jovyan/yewon/PITR/mmdetection/data/PITR/train_modified/',
        classes=classes,
        pipeline=train_pipeline,
        ann_file='/home/jovyan/yewon/PITR/mmdetection/data/PITR/annotations/train.json'),
    val=dict(
        img_prefix='/home/jovyan/yewon/PITR/mmdetection/data/PITR/valid_modified/',
        classes=classes,
        pipeline=test_pipeline,
        ann_file='/home/jovyan/yewon/PITR/mmdetection/data/PITR/annotations/valid.json'),
    test=dict(
        img_prefix='/home/jovyan/yewon/PITR/mmdetection/data/PITR/test_modified/',
        classes=classes,
        pipeline=test_pipeline,
