...
data = dict(
    ...
    workers_per_gpu=2,
    train=dict(
        img_prefix='/root/PITR/KSMD/data/PITR/train/',
        classes=classes,
        pipeline=train_pipeline,
        ann_file='/root/PITR/KSMD/data/PITR/annotations/train.json'),
    val=dict(
        img_prefix='/root/PITR/KSMD/data/PITR/val/',
        classes=classes,
        pipeline=test_pipeline,
        ann_file='/root/PITR/KSMD/data/PITR/annotations/val.json'),
    test=dict(
        img_prefix='/root/PITR/KSMD/data/PITR/test/',
        classes=classes,
        pipeline=test_pipeline,
        ann_file='/root/PITR/KSMD/data/PITR/annotations/test.json'),
   )
...
work_dir = './work_dirs/dyhead_swin-L_fpn_3x_pitr_LR3e-5'